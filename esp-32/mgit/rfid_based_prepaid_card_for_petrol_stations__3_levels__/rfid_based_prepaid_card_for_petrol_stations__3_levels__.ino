...
//char auth[] = "dd0f2e56bafa41f0b8aa20e0fbcb10a7";
...
Serial.println("sending welcome message............");
 ...
 if(WiFi.status()== WL_CONNECTED){ //Check WiFi connection status
   ...
   http.begin("http://sms.scubedigi.com/api.php?username=Mydreamacd&password=Mydre@m123&to=8897070983&from=MYDREM&message=WELCOME%20TO%20PROJECT"); //Specify request destination
...
tank_level ();
    ...
    lcd1.print(0,1,"LEVEL: "+String(level));
    delay(1000);
...
/*
msg = "http://sms.scubedigi.com/api.php?username=Mydreamacd&password=Mydre@m123&to=8897070983&from=MYDREM&message=";
...
if(WiFi.status()== WL_CONNECTED){ //Check WiFi connection status
    ...
    HTTPClient http; //Declare an object of class HTTPClient
   // http.begin("http://sms.scubedigi.com/api.php?username=Mydreamacd&password=Mydre@m123&to=8897070983&from=MYDREM&message=RJANED;LKSDF"); //Specify request destination
