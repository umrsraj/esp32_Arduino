...
String iot = "\0";
String p = "http://sms.scubedigi.com/api.php?username=Mydreamacd&password=Mydream123&to=9381256458&from=MYDREM&message=";
String msg = "\0";
String gas2 = "\0";
...
{
  box1 = "N";
msg = p + "NOT%20TAKEN%20MEDICINE%201";  
sendmsg();  
...
msg = p + "NOT%20TAKEN%20MEDICINE%202";  
sendmsg();   
...
msg = p + "NOT%20TAKEN%20MEDICINE%203";  
sendmsg();  
